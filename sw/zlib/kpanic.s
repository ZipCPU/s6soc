...
;;
;; Purpose:	This script is drawn (mostly) from the resetdump.s script
;;		found in the zipos.  It is designed to dump the initial register
;;	set upon bootup, the address of the last bus error, and (possibly)
;;	the contents of the scope (assuming it had tripped).
;;
...
kpanic_wait_for_button:
	...
	.global		internal_kpanic
	.type		internal_kpanic,@function
internal_kpanic:
